...
export default function CampaignModal({ campaign, isOpen, onClose, wallet }: CampaignModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      ...
      <div className="relative bg-[#0f1117] border border-white/10 w-full max-w-4xl max-h-[90vh] rounded-2xl flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150 z-10">
        ...
        <div className="overflow-y-auto p-6 space-y-8 flex-1">
          ...
          <div className="space-y-6">
            <div className="text-sm text-gray-500 border border-white/10 rounded-xl p-4 bg-[#141722]">
              <DonationStatsComponent campaignAddress={campaign.targetAddress} goal={campaign.goal} />
            </div>
            
            <div className="text-sm text-gray-500 border border-white/10 rounded-xl p-4 bg-[#141722]">
              <DonateButton wallet={wallet} fundAddress={campaign.targetAddress} />
